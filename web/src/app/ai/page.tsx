...
if (parsed.tool === 'webAutomation') {
        ...
        try {
          ...
          if (d.ok) {
            ...
            steps = d.steps || (d.screenshot ? [{ action: 'Browser view', screenshot: d.screenshot, url: d.url || browseUrl, title: d.title || '' }] : [])
          } else {
